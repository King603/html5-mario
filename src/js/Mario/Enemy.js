    ...
    Draw(ctx) {
        if (this.Winged) {
            ...
            if (this.Type !== Enemy.RedKoopa && this.Type !== Enemy.GreenKoopa) {
                ...
                ctx.drawImage(this.Image, (this.WingTime / 4 | 0) % 2 * 16, 128, 16, 32, this.XFlip ? 320 - c - 24 : c - 8, this.YFlip ? 240 - e - 32 : e - 8, 16, 32);
                ctx.restore();
                this.XFlip = !this.XFlip;
            }
        }

...
export class Shell extends NotchSprite {
	...
	OnGround = !1;
	Anim = 0;
	constructor(public World: LevelState, public X: number, public Y: number, public Ypic: number, public Xpic = 4) {
	...
	IsBlocking(a: number, b: number, c: number, e: number) {
		a = a / 16 | 0;
		b = b / 16 | 0;

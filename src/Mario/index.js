...
Mario.LevelType = { Overground: 0, Underground: 1, Castle: 2 }
Mario.Odds = { Straight: 0, HillStraight: 1, Tubes: 2, Jump: 3, Cannons: 4 }

Mario.Level = function (a, b) {
	this.Width = a;
	this.Height = b;
	...
	for (var c = 0, e = 0, c = 0; c < this.Width; c++) {
		...
		for (e = 0; e < this.Height; e++)
			(this.Map[c][e] = 0),
				(this.Data[c][e] = 0),
				(this.SpriteTemplates[c][e] = undefined);
	}
}
Mario.Level.prototype = {
	...
	IsBlocking: function (a, b, c, e) {
		...
		b |=
			e > 0 &&
			(Mario.Tile.Behaviors[a & 255] & Mario.Tile.BlockUpper) > 0;
		b |=
			e < 0 &&
			(Mario.Tile.Behaviors[a & 255] & Mario.Tile.BlockLower) > 0;
		return b;
	},
	GetSpriteTemplate: function (a, b) {
		if (a < 0) return undefined;
		if (b < 0) return undefined;
		if (a >= this.Width) return undefined;
		if (b >= this.Height) return undefined;
...
Mario.Character.prototype = new Mario.NotchSprite(undefined);
...
Mario.LevelRenderer.prototype.DrawDynamic = function (a, b) {
	for (
		var c = 0, e = 0, d = 0, f = 0, g = 0, d = undefined, c = (b.X / 16) | 0;
...
Mario.LevelRenderer.prototype.DrawExit0 = function (a, b, c) {
	for (
		var e = 0, e = 0, d = undefined, e = this.Level.ExitY - 8;
		e < this.Level.ExitY;
		e++
	)
...
Mario.LevelRenderer.prototype.DrawExit1 = function (a, b) {
	for (
		var c = 0, e = undefined, c = this.Level.ExitY - 8;
		c < this.Level.ExitY;
		c++
	)
...
Mario.Enemy.prototype.ShellCollideCheck = function (a) {
	...
	if (b > -16 && b < 16 && c > -this.Height && c < a.Height) {
		...
		this.Ya = -5;
		this.FlyDeath = !0;
		if (this.SpriteTemplate !== undefined) this.SpriteTemplate.IsDead = !0;
		this.DeadTime = 100;
		this.Winged = !1;
		return (this.YFlip = !0);
	}
...
Mario.LoadingState.prototype.Enter = function () {
	...
	this.Images[0].src = "public/images/bgsheet.png";
	this.Images[1].src = "public/images/endscene.gif";
	this.Images[2].src = "public/images/enemysheet.png";
	this.Images[3].src = "public/images/firemariosheet.png";
	this.Images[4].src = "public/images/font.gif";
	this.Images[5].src = "public/images/gameovergost.gif";
	this.Images[6].src = "public/images/itemsheet.png";
	this.Images[7].src = "public/images/logo.gif";
	this.Images[8].src = "public/images/mapsheet.png";
	this.Images[9].src = "public/images/mariosheet.png";
	this.Images[10].src = "public/images/particlesheet.png";
	this.Images[11].src = "public/images/racoonmariosheet.png";
	this.Images[12].src = "public/images/smallmariosheet.png";
	this.Images[13].src = "public/images/title.gif";
	this.Images[14].src = "public/images/worldmap.png";
...
Mario.WinState = function () {
	this.waitTime = 2;
	this.kissing = this.font = this.camera = this.drawManager = undefined;
	this.wasKeyDown = !1;
};
	...
	for (
		...
		for (b = 0; b < 16; b++)
			(c = d.PerlinNoise(a * 10 + h, b * 10 + i)),
				...
				(c *= 2),
				(this.Level[a][b] =
					c > 0 ? Mario.MapTile.Water : Mario.MapTile.Grass);
	}
	f = d = 9999;
...
Mario.MapState.prototype.FindConnection = function (a, b) {
	for (var c = 0, e = 0, c = 0; c < a; c++)
		for (e = 0; e < b; e++)
			if (
				this.Level[c][e] === Mario.MapTile.Level &&
				this.Data[c][e] === -1
			)
...
Mario.MapState.prototype.FindCaps = function (a, b) {
	for (
		var c = 0, e = 0, d = -1, f = -1, g = 0, h = 0, i = 0, c = 0;
		c < a;
		c++
	)
		for (e = 0; e < b; e++)
...
Mario.LevelState.prototype.Update = function (a) {
	...
	for (
		b = this.FireballsOnScreen = 0;
		b < this.Sprites.Objects.length;
		b++
	)
		...
		(this.BumpInto(a, b - 1),
			...
			(Mario.Tile.Behaviors[e & 255] & Mario.Tile.Special) > 0
				? (Enjine.Resources.PlaySound("sprout"),
					Mario.MarioCharacter.Large
						? this.AddSprite(
							new Mario.FireFlower(this, a * 16 + 8, b * 16 + 8)
						)
						: this.AddSprite(
							new Mario.Mushroom(this, a * 16 + 8, b * 16 + 8)
						))
